...
public class Class_3_Constructor {
	...
	public static void main(String[] args) {
		...
		Class_3_Constructor myobj = new Class_3_Constructor("Jafrin", 25, "Sylhet"); //Creating object for specific instance 
		...
		Class_3_Constructor myobj2 = new Class_3_Constructor("Jubair", 30, "BD"); //Creating another object 
